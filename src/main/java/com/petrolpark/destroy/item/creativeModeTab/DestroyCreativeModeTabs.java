	...
	public static final RegistryObject<CreativeModeTab> MAIN_TAB = TABS.register(
		...
		() -> new CustomTab.Builder(CreativeModeTab.Row.TOP, 0)
			.add(
				...
				n(), i(DestroyItems.NETHER_CROCOITE_INFUSED_BEETROOT_ASHES), i(DestroyItems.NICKEL_INFUSED_BEETROOT_ASHES), i(DestroyItems.QUARTZ_INFUSED_BEETROOT), i(DestroyItems.REDSTONE_INFUSED_BEETROOT_ASHES), i(DestroyItems.ZINC_INFUSED_BEETROOT_ASHES),
